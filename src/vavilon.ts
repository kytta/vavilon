...
export default class Vavilon {
   ...
   * However, if the user switches to a new language, and then back to {@link pageLocale}, the value
   * will be {@link pageLocale}.
   */
  ...
  public addDicts(): void {
    Array.from(document.scripts)
      .filter((e): boolean => Object.prototype.hasOwnProperty.call(e.dataset, 'vavilonDict'))
      .forEach((ds): void => {
